...
namespace JournalKIT.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public ActivitiesController(KitContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nameactivity,Datecreate,Property,Oneshot,Creator,Crreatoristutor")] Activity activity)
        {
            if (id != activity.Id)
            {
                return NotFound();
